...
#         stu = get_object_or_404(Student, id=id)  # Fetch student instance safely
#         fm = AddStudentForm(instance=stu)
#         return render(request, 'core/edit-student.html', {'form': fm})

#     def post(self, request, id):
#         stu = get_object_or_404(Student, id=id)  # Fetch student instance
#         fm = AddStudentForm(request.POST, instance=stu)
#         if fm.is_valid():  # Add parentheses
#             fm.save()
#             return redirect('/')  # Redirect after saving

#         return render(request, 'core/edit-student.html', {'form': fm})  # Show form again if invalid
